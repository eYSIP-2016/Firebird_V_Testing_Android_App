        ...
        builder.setCancelable(false)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        ((MyApplication) activity.getApplication()).setIsVelocityActivityLaunchedFirst(true);
                        ((MyApplication) activity.getApplication()).setLeftSeekbarValue(255);
                        ((MyApplication) activity.getApplication()).setRightSeekbarValue(255);
                        finish();
                        //  close();
                    }
                })
