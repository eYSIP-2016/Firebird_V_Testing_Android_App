 ...
 * Filename: SharpSensorActivity.java
 ...
 *            onOptionsItemSelected(MenuItem), sharpReadValues(), Sharp_GP2D12_estimation(int)
 *
...
/*
 *
 * Class Name: SharpSensorActivity
 * Logic: This activity gets the sharp sensor values from the robot using background bluetooth service and sets the values in
 *        bar chart
 * Example Call: new SharpSensorActivity()
 *
 */
public class SharpSensorActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //sets the font for ActionBAr title
    ...
    /**
     * Function Name: sharpReadValues
     * Input: None
     * Output: sends the data to the robot to get the sharp sensor values and sets the values obtained to the 'entries' ArrayList
     * Logic: sends the data till the time activity is binded to the bluetooth service and readSensors value is true
     * Example Call: sharpReadValues()
     */
                    ...
                    for (int i = 0; i < 5; i++) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                // stores the value read from the input stream into the arraylist after estimating its value
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home_sensor) {
            Intent i = new Intent(SharpSensorActivity.this, SensorActivity.class);
