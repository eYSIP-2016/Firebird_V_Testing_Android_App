 ...
 * Global Variables: SPLASH_TIME_OUT, mAdapter, animFadeIn, title
 */
...
public class SplashScreenActivity extends Activity {
    ...
    //to hold the UI TExtView component
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //binds with the UI title component
        ...
        //saves the state of the bluetooth before using it
